...
const SideBar = ({ currentPage, onPageChange }) => {
  const menuItems = [
    ...
    { id: 'themes', label: 'Themes', section: 'customization' },
    { id: 'settings', label: 'Setting', section: 'customization' },
  ]
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
            <nav className="-mx-3 space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <button 
                      onClick={() => onPageChange('hotspots')}
                      className={getLinkClass('hotspots')}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
                    ...
                    <button 
                      onClick={() => onPageChange('checklists')}
                      className={getLinkClass('checklists')}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
