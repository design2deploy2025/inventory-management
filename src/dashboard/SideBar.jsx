...
const SideBar = ({ currentPage, onPageChange }) => {
  ...
  const menuItems = [
    ...
    { id: 'customers', label: 'Customers', section: 'analytics' },
    { id: 'analytics', label: 'Analytics', section: 'analytics' },
    { id: 'feedback', label: 'Feedback', section: 'feedback' },
    { id: 'settings', label: 'Profile', section: 'settings' },
  ]
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
            <nav className="-mx-3 space-y-6">
                ...
                <div className="space-y-3">
                    <label className="px-3 text-xs text-slate-500 uppercase tracking-wider">Manage</label>
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.5l2.25 10.5h11.25l2.25-7.5H6.75"/>
  ...
  <circle cx="18" cy="20" r="1.5"/>
                ...
                {/* Analytics Section */}
                <div className="space-y-3">
                    <label className="px-3 text-xs text-slate-500 uppercase tracking-wider">Analyze</label>
                ...
                {/* Support Section */}
                <div className="space-y-3">
                    <label className="px-3 text-xs text-slate-500 uppercase tracking-wider">Support</label>
                ...
                {/* Settings Section */}
                <div className="space-y-3">
                    <label className="px-3 text-xs text-slate-500 uppercase tracking-wider">Profile</label>
