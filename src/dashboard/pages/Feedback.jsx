    ...
    <div className="min-h-screen bg-[#0A0A0A] p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Response Time */}
          <div className="bg-gradient-to-br from-indigo-900/20 to-purple-900/10 backdrop-blur-xl border border-indigo-500/20 p-6">
          ...
          <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 backdrop-blur-xl border border-white/5 p-6">
            ...
            <div className="space-y-3">
              <a
                href="mailto:design2deploy.2025@gmail.com"
