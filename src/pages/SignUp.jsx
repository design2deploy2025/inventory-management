		...
		<section>
		  ...
		  <div className="grid gap-0 md:h-screen md:grid-cols-2">
            ...
            <label className="mb-6 flex items-center justify-start pb-12 pl-5 font-medium md:mb-10 lg:mb-1 text-slate-300">
		            ...
		            <input type="submit" value="Start Free Trial" className="inline-block w-full cursor-pointer items-center bg-indigo-600 hover:bg-indigo-700 transition px-6 py-3 text-center font-semibold text-white rounded-full" />
		          </form>
		        </div>
